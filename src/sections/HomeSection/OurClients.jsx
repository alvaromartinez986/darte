...
const OurClients = () => {
  ...
  const clients = [
    { img: Client1, name: "joy", imgSx: { backgroundSize: "90%" } },
    { img: Client2, name: "evolucion", imgSx: { backgroundSize: "70%" } },
    { img: Client3, name: "piaget", imgSx: { backgroundSize: "80%" } },
    { img: Client4, name: "duqueria", imgSx: { backgroundSize: "90%" } },
    { img: Client5, name: "dental", imgSx: { backgroundSize: "70%" } },
    { img: Client6, name: "yoga", imgSx: { backgroundSize: "80%" } },
  ];
